...
- **Portus** – AI-powered brand identity platform using LangGraph, MCP protocol, Claude Desktop integration with FastMCP for agent orchestration
- **[Obelisk](https://theobelisk.app)** – Multi-tenant SaaS marketing automation (Vue.js/FastAPI) with pgvector knowledge retrieval, deployed on GCP Cloud Run
